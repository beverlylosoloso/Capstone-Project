<?php
class Controller_Admin_Personal_info extends Controller_Admin
{

	public function action_index()
	{
		$data['personal_info'] = Model_Personal_info::find('all');
		$this->template->title = "Personal_info";
		$this->template->content = View::forge('admin/personal_info/index', $data);
	...
	public function action_view($id = null)
	{
		...
		$this->template->title = "Personal_info";
		$this->template->content = View::forge('admin/personal_info/view', $data);
	...
	public function action_create()
	{
		if (Input::method() == 'POST')
		{
			...
			if ($val->run())
			{
				...
				if ($personal_info and $personal_info->save())
				{
					...
					Response::redirect('admin/personal_info');
				}
		...
		$this->template->title = "Personal_info";
		$this->template->content = View::forge('admin/personal_info/create');
	...
	public function action_edit($id = null)
	{
		...
		$this->template->title = "Personal_info";
		$this->template->content = View::forge('admin/personal_info/edit');
